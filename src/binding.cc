...
#define SET_ALIGNOF(name, type) \
  ...
  // exports
  target->Set(Nan::GetCurrentContext(), Nan::New<v8::String>("sizeof").ToLocalChecked(), smap);
  target->Set(Nan::GetCurrentContext(), Nan::New<v8::String>("alignof").ToLocalChecked(), amap);
